...
| 3   | Ответить на 6 вопросов | Бот генерирует план через LLM |
...
- [✔️] `/plan` → 6 вопросов → GPT → PlanCreated event, запись в `weekly_plans`
...
| 2 | Планирование недели       | `/plan` → 6 вопросов                    | PlanCreated, weekly_plans             |
...
1. `/plan`  
2. Ответить на 6 вопросов (current_state, main_focus, weekly_result, why_now, distractions, main_risk)  
