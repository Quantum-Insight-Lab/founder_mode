...
export const workConfig: ModeConfig = {
  ...
  onboarding: {
    msgs: [
      'Work Mode: довести показатель или одну задачу до результата за неделю.',
  ...
  commitment: {
    titleQuestion: 'Какой показатель или рабочую задачу доводишь до результата на этой неделе?',
    followups: [
