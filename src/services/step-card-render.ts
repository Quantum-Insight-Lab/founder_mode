...
export type StepCardPngInput = CardHtmlInput;

const STEP_CARD_PRESETS = [
...
export async function renderStepCardPng(input: StepCardPngInput): Promise<Buffer> {
  return renderCardPngWithPresets(input, STEP_CARD_PRESETS, 'step');
}
